...
- When using the command "screen -c", it must be specifically in this format: screen -c <process_name> <process_memory_size> "<instructions>", the process_memory_size can be 256
